                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                   ...
                                   <!--  <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="receiver_address" style="text-transform: uppercase;"><strong>SKU Code </strong></label>
                                            <input class="form-control form-control-lg mb-3" type="text" name="sku" value="{{ old('SKU Code') }}" placeholder="SKU Code ">
                                        </div>
                                    </div> -->
                                </div>
                            </div>
