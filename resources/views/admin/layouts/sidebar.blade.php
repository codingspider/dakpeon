<div class="sidebar sidebar-dark bg-dark">
    <ul class="list-unstyled">
        ...
        <li id="companyIncomeList"><a href="{{ URL::to('all/courier/') }}"><i class="fa fa-fw fa-address-card"></i> All Bookings </a></li>
        <li>
            ...
            <ul id="frontend" class="list-unstyled collapse ">
                ...
                <li><a href="{{ route('frontend.curriercount') }}"><i class="far fa-circle"></i> Currier Count Info</a></li>
                ...
                <li><a href="{{ route('frontend.searchcurrier') }}"><i class="far fa-circle"></i> Search Currier</a></li>
