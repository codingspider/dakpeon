...
Route::get('all/courier', 'ManageCourierController@index');
Route::get('all/view/{id}', 'ManageCourierController@view');
Route::get('courier/status/pending/{cid}', 'ManageCourierController@pending');
Route::get('courier/status/delivered/{id}', 'ManageCourierController@deliver');
Route::get('courier/status/on_the_Way/{id}', 'ManageCourierController@ontheway');
Route::get('courier/status/return/{id}', 'ManageCourierController@return');
Route::get('courier/status/cancelled/{id}', 'ManageCourierController@cancelled');
